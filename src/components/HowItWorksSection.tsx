  ...
  return (
    <section id="how-it-works" className="py-16 md:py-24 bg-gray-50">
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
        ...
        <div className="mb-12">
          <p
            className="bg-primary text-background w-fit px-3 py-0.5 rounded-full 
          text-sm font-semibold mb-2"
          >
            ★ Hoe BetterE werkt
          </p>
          <h2 className="mt-4 text-3xl lg:text-4xl font-bold mb-4 text-foreground">
                  ...
                  {tabs[activeTab].points.length > 0 && (
                    <div className="flex flex-col sm:flex-row gap-3">
                      {tabs[activeTab].points.map((point, idx) => (
                        ...
                        >
                          <div className=" mb-3 p-2 rounded-full bg-background w-fit shrink-0">{point.icon}</div>
