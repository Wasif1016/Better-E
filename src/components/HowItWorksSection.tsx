...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" className="pt-8 pb-12 sm:pt-16 sm:pb-16 lg:pt-20 lg:pb-20 bg-gray-50">
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-12 text-left lg:text-left" id="gebruik">
          <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-6 sm:mb-3 text-foreground">
            ★ Hoe het werkt
          </h2>
