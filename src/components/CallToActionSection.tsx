  ...
  return (
    <section id="cta" className="py-16 md:py-24">
      <div className="max-w-[1400px] mx-auto px-4">
        ...
        <div className="flex flex-col rounded-2xl bg-green-400 py-8 md:py-10 px-4 md:px-10 justify-center max-w-5xl mx-auto p-4 md:p-8">
          <h2 className="section-title">BetterE voor jou</h2>
          <div className='flex gap-4 md:gap-6 py-6 flex-col md:flex-row'>
            {/* 1st */}
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100 text-center flex-1">
